...
path = '/local/tmp/jem_iris_brute_force_75/'
			...
			for y in range(0,b):
				for x in range(0,c):
					for w in range(0,d):
						...
						log = open('log.txt',"r")
						save_file = open('accuracies_100.txt',"a")
			...
			for u in range(0,f):
				...
				for line in log:
					if 'caffe.cpp:330] accuracy = ' in line:
						...
						save_file.write(str(index_num) + ',' + str(line[start+3:end]) + ',layer_name=' + str(layer_name) + ',v=' + str(v) + ',u=' + str(u) + '\n')
